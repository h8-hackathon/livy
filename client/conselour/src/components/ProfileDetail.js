  ...
  return (
    <div className="px-8 p-10 overflow-auto">
      ...
      <div className="mt-10">
        ...
        <form className="space-y-8 mt-10 text-center">
          ...
          <div className="space-y-1">
            ...
            {edit ? <input name="email" onChange={inputHandler} value={form.email} className="px-3 py-2 text-xs w-3/4 outline-none" type="email" required  /> : <p className="text-base">{counselor.email || 'Not set'}</p>}
          </div>
          <div className="space-y-1">
          ...
          <div className="space-y-4">
            ...
            {edit ? <input name="dob" onChange={inputHandler} value={form.dob} className="px-3 py-2 text-xs w-3/4 outline-none" type="date"  required /> : <p className="text-base">{counselor.dob || 'Not set'}</p>}
          </div>
          {
